...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { description: @login.description, login: @login.login, senha: @login.senha } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { description: @login.description, login: @login.login, senha: @login.senha } }
